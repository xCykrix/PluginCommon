package com.github.xcykrix.plugincommon.api.helper.configuration;
...
public class LanguageFile extends Stateful {
    ...
    public LanguageFile(PluginCommon pluginCommon, YamlDocument base) {
        super(pluginCommon);
        this.base = base;
